...
import { logo,menu,Vector,mainp,dollar} from "../assets";
...
const Token = () => {
    ...
    const handleSearch = () => {
        ...
        if (searchQuery.trim() !== "") {
            ...
            setSearchQuery(""); // Reset searchQuery to trigger the default API call
        }
    };
    ...
    useEffect(() => {
        if (searchQuery === "") {
            axios
                .get(`https://api.dexscreener.com/latest/dex/pairs/bsc/0x7213a321F1855CF1779f42c0CD85d3D95291D34C,0x16b9a82891338f9ba80e2d6970fdda79d1eb0dae`)
                .then((response) => {
    ...
    return (
        <section className={`flex md:flex-row bg-dark-gradient flex-col ${styles.paddingY}`}>
            <div className="flex w-full flex-col p-6 m-4 bg-black-gradient items-start rounded-xl">
                <div className="mb-4 bg-transparent flex flex-wrap justify-between w-full  gap-2 items-start">
                    <input
                        type="text"
                ...
                <h1 className="font-poppins text-[25px] text-white font-bold m-8">
                    Pair Search Result
                </h1>
                <br />
                <div className="flex flex-col mt-4 py-4">
                   
                    <ul className="flex flex-wrap sm:flex-row gap-8 sm:px-8">
                ...
                />
                                ...
                                <div className="bg-[#390554] p-8 flex items-start flex-row rounded-xl w-[300px]">
                                    <div className="flex flex-col">
                                        ...
                                        <img
                    className="w-[48px] h-[48px] bg-[#F30050] rounded-full p-2 object-contain relative md:top-10 top-6 left-40 mx-12" 
